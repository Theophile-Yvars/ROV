...
import { Wifi, BatteryCharging, Clock, Zap, Target } from 'lucide-react';

interface StatusBarProps {
  rovIp: string;
}

const StatusBar: React.FC<StatusBarProps> = ({ rovIp }) => {
  const [missionTime, setMissionTime] = useState(0);

  // Simple timer de mission
  useEffect(() => {
